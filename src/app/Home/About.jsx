...
const About = () => {
  return (
    <>
      <div className="w-screen h-fit py-16 flex justify-start items-center flex-col">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-center text-white w-[300px] md:w-4xl text-md md:text-xl font-space">
